...
// numbers: are used for numbers (can hold decimal numberws and whole numbers)
...
// control flow(loops(folr,while,for in,for of) and conditional statement(if,else,else if,switch,ternary operator and a block of code))
...
let person1 = {
  ...
  height: 1.99,
  calcBMI: function () {
    let pass = this.mass / this.height;
    return pass;
  },
};
